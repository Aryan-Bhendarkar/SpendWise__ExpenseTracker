...
// Load existing transactions from localStorage or initialize with sample data
try {
    const storedTransactions = localStorage.getItem('transactions');
    if (storedTransactions) {
        transactions = JSON.parse(storedTransactions);
        console.log('Loaded existing transactions from storage');
    } else {
...
// Load or set default monthly budget
let monthlyBudget = parseFloat(localStorage.getItem('monthlyBudget')) || 15000;
